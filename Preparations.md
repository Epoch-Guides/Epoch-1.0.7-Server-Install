...
* Download and install [Notepad++](https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.1.9.3/npp.8.1.9.3.Installer.x64.exe), or use your Favorite Text/Code Editor if you already have one. We have our recommendation for Server Scripting: Visual Studio Code, which we will walk you through later in [Editing The Server](../main/EditingTheServer.md)

* Install **all** of the Visual Studio C++ Redistributables located in the DayZ Epoch 1.0.7 Server Files you downloaded earlier, failure to do so will result in crashes further down the line. Restart the PC after installing these.
